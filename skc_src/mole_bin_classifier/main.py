...
class Config:
    INPUT_DIR = Path('/Users/francesco/Repository/computer_vision_project/dataset/mix_dataset/categorized_images')
    OUTPUT_DIR = Path('outputs')
    MODEL_DIR = Path('/Users/francesco/Repository/computer_vision_project/saved_models')
    BALANCED_DIR = Path('/Users/francesco/Repository/computer_vision_project/dataset/mix_dataset/balanced_images')
